...
pg_dump -h localhost -d learning-from-our-past -U postgres --format=c -n siirtokarjalaisten_tie -n system | openssl smime -encrypt -aes256 -binary -outform SMIME -out learning-from-our-past-dump.ssl ./backup_key.pem.pub
